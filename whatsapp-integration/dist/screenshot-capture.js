...
export class InspirationScreenshotCapture {
    screenshotDir;
    constructor(screenshotDir = './temp/screenshots') {
     ...
     */
    async captureWebsiteScreenshots(url, options = {}) {
        const results = [];
     ...
     */
    async waitForMeaningfulContent(page, maxMs) {
     ...
     */
    getSuccessfulScreenshots(results) {
        return results
 ...
 */
export async function captureInspirationScreenshots(urls, options = {}) {
