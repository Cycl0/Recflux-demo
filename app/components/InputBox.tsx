  ...
  return (
    <form className="relative md:w-3/4 w-full h-12 mx-auto max-w-4xl" onSubmit={handleGeneration}>
      <main className={`
        ...
        ref={gridRef}
      >
        <section className="grid-in-select h-12 transition-all ease-in-out delay-500 duration-200">
          <select
            id="options"
            className="w-full h-full p-2.5 pr-8 appearance-none text-blue-700 border-b-2 border-blue-400  focus:border-green-200 focus:ring-2 border-none bg-blue-100 block transition-colors duration-200 ease-in-out uppercase rounded-tl-md hover:z-20 focus:z-20"
        ...
        <section className="grid-in-input h-12 relative shadow-gradient underline-slide transition-all ease-in-out delay-200 duration-500">
          <div className={`w-full h-12`}>
            ...
            <div className="h-full relative w-full outline-none flex">
              <input
                type="search"
                id="search-dropdown"
                className="flex-grow h-full block p-2.5 text-blue-600 focus:outline-none focus:ring-0 border-none bg-blue-200 placeholder-white transition-colors duration-200 ease-in-out uppercase font-bold hover:z-20 focus:z-20"
              ...
              <button
                ...
                className={`w-12 h-full bubble-animation p-2.5 font-medium h-full text-white bg-blue-300 rounded-tr-md border border-blue-300 hover:bg-transparent  hover:border-green-400 hover:outline-none transition-all duration-1000 ease-in-out hover:scale-[105%] group transform-gpu hover:z-20 focus:z-20 ${isClicked ? 'clicked' : ''
                  }`}
              >
        ...
        <button
          ...
          className={`
                      ...
                      bg-[rgba(193,219,253,0.15)] backdrop-blur-md
        ...
        <section className={`
                             grid-in-files
                             ${editorSideBarMode ? `neon-l-shape-right` : `neon-l-shape-left`}`}>
          <div className={`
        ...
        <section
          ...
          <div
            ...
            <button
              onClick={(e) => {
                e.preventDefault();
                setEditorSideBarMode(!editorSideBarMode);
              }}
